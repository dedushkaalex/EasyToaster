...
function useArrayIncludes(...args) {
  ...
  comparator =
    comparator != null ? comparator : (element, value2) => element === toValue(value2);
  return computed(() =>
    toValue(list)
      .slice(formIndex)
...
function formatDate(date, formatStr, options = {}) {
  ...
  return formatStr.replace(REGEX_FORMAT, (match, $1) => {
    var _a2, _b;
    return (_b =
      $1 != null ? $1 : (_a2 = matches[match]) == null ? void 0 : _a2.call(matches)) !=
      null
      ? _b
      : match;
  });
    ...
    detectIframe &&
      useEventListener(window2, 'blur', (event) => {
        setTimeout(() => {
          ...
          const el = unrefElement(target);
          if (
            ((_a = window2.document.activeElement) == null ? void 0 : _a.tagName) ===
              'IFRAME' &&
...
function useNow(options = {}) {
  const { controls: exposeControls = false, interval = 'requestAnimationFrame' } =
    options;
...
function usePointerSwipe(target, options = {}) {
  ...
  const eventIsAllowed = (e) => {
    ...
    return (_c =
      (_b = (_a = options.pointerTypes) == null ? void 0 : _a.includes(e.pointerType)) !=
      null
        ? _b
...
function useTextSelection(options = {}) {
  ...
  const text = computed(() => {
    var _a, _b;
    return (_b = (_a = selection.value) == null ? void 0 : _a.toString()) != null
      ? _b
      : '';
  });
...
function useTitle(newTitle = null, options = {}) {
  ...
  const title = toRef2(
    (_b = newTitle != null ? newTitle : document2 == null ? void 0 : document2.title) !=
      null
      ? _b
      : null
  );
...
function useVModel(props, key, emit, options = {}) {
  ...
  if (!key) {
    if (isVue2) {
      const modelOptions =
        (_e = (_d = vm == null ? void 0 : vm.proxy) == null ? void 0 : _d.$options) ==
        null
          ? void 0
          : _e.model;
